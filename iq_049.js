...
for(var i = 0; i < holes.length; i++){
  ...
  $("#h"+i+"-diameter, #h"+i+"-diameter-range").val($(inputs[0]).val());
  $("#h"+i+"-distance, #h"+i+"-distance-range").val($(inputs[1]).val());
  $("#h"+i+"-angle, #h"+i+"-angle-range").val($(inputs[2]).val());

   // Trigger the change events to update the 3D model
  $("#h"+i+"-diameter-range").trigger('input');
  $("#h"+i+"-distance-range").trigger('input'); 
  $("#h"+i+"-angle-range").trigger('input');
}
