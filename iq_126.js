...
CircularHolesSystem.prototype.createHoleDimensionLines = function(hole, index) {
    const unit = $("#unit").val();
    const z = this.cylinderHeight / 2 + 0.002;
...
CircularHolesSystem.prototype.createHoleLabel = function(hole, x, y, z, index, spacing) {
    const unit = $("#unit").val();
...
CircularHolesSystem.prototype.createAxisLines = function() {
    const unit = $("#unit").val();
    const z = this.cylinderHeight / 2 + 0.002;
    const spacing = getDimensionSpacing(unit);
...
PieSliceSystem.prototype.createSliceDimensions = function() {
    const unit = $("#unit").val();
    const z = this.cylinderHeight / 2 + 0.002;
    const spacing = getDimensionSpacing(unit);
...
PieSliceSystem.prototype.createParameterLabels = function() {
    const unit = $("#unit").val();
    const z = this.cylinderHeight / 2 + 0.002;
    const spacing = getDimensionSpacing(unit);
...
CrescentSystem.prototype.createCrescentDimensions = function(z, geometry) {
    const unit = $("#unit").val();
    const spacing = getDimensionSpacing(unit);
    ...
    // Continue with other dimensions using consistent spacing...
    // (Add the rest of the crescent dimension methods with spacing applied)
};
...
if (distanceInput) {
   ...
   SmileSystem.prototype.createSmileHoleDimensionLines = function(hole, index) {
    const unit = $("#unit").val();
    const z = this.cylinderHeight / 2 + 0.002;
    const spacing = getDimensionSpacing(unit);
    const extensionDistance = this.cylinderRadius + spacing.extensionDistance;
   ...
   SmileSystem.prototype.createSemicircleDimensions = function(z) {
    const unit = $("#unit").val();
    const spacing = getDimensionSpacing(unit);
