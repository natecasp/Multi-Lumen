...
updateHoleDiameter(index, newDiameter, valueDisplay, warningElement) {
    ...
    // Update display to show actual constrained value
    valueDisplay.textContent = constrainedDiameter.toFixed(4);
...
findClosestValidRadius(x, y, targetRadius, holeIndex) {
    const maxRadius = 0.03; // Your maximum allowed radius
    const minRadius = 0.005; // Your minimum allowed radius
...
updateHoleAngle(index, newAngle, valueDisplay, warningElement) {
    ...
    // Update displays
    valueDisplay.textContent = Math.round(constrainedAngle) + '°';
...
updateHoleDistance(index, newDistance, valueDisplay, warningElement) {
    ...
    // Update displays
    valueDisplay.textContent = constrainedDistance.toFixed(4);
