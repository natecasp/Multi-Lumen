...
captureModelImage(captureWidth = 600, captureHeight = 600) {
    return new Promise((resolve) => {
        ...
        // Calculate and set consistent camera settings for capture
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    // Create capture canvas at desired resolution
                    ...
                    try {
                        // Calculate scaling from current sandbox to desired capture size
                        ...
                        // Draw the WebGL content scaled and centered
                        captureCtx.drawImage(
                            this.renderer.domElement,
                            offsetX, offsetY, scaledWidth, scaledHeight
                        );
                        
                        console.log('Drew WebGL content with scale:', scale);
                    } catch (error) {
                        console.error('Error drawing WebGL:', error);
                    }
                    
                    // Draw CSS2D elements with proper scaling
                    if (this.isPrintMode && this.css2dRenderer && 
                        this.css2dRenderer.domElement.style.display !== 'none') {
                        this.drawCss2dElementsScaled(captureCtx, captureWidth, captureHeight);
                    }
