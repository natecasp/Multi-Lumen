    ...
    return new Promise((resolve) => {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                }, 50); // Longer delay for CSS2D positioning
            }, 50);
        }, 50);
    });
}
...
<div class="title-block"><div><p class="delete">x</p><p class="line-title">Line `+ lineItem +` (`+ unit +`)</p><p class="edit" id="`+ lineItem +`">Edit</p></div>${thumbnailHtml}</div>
