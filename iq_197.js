...
updateGlobalDistanceLimits() {
    ...
    const outerConstraint = this.cylinderRadius - maxHoleRadius - this.minimumSeptum;
    ...
    const minDistanceFromSemicircle = this.semicircleRadius + maxHoleRadius + availableSpace;
    
    const maxDistance = outerConstraint;
    const minDistance = Math.max(maxHoleRadius + this.minimumSeptum, minDistanceFromSemicircle);
