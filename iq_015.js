...
updateSliderValues(holeIndex) {
    ...
    const angleValueDisplay = document.getElementById(`h${holeIndex}-angle-value`);
    ...
    const distanceValueDisplay = document.getElementById(`h${holeIndex}-distance-value`);
    ...
    const diameterValueDisplay = document.getElementById(`h${holeIndex}-diameter-value`);
    ...
    if (distanceSlider && distanceInput && distanceValueDisplay) {
        ...
        distanceValueDisplay.textContent = hole.distance.toFixed(3);
    }
    if (diameterSlider && diameterInput && diameterValueDisplay) {
        diameterSlider.value = (hole.radius*2).toFixed(3);
        diameterInput.value = (hole.radius*2).toFixed(3);
        diameterValueDisplay.textContent = (hole.radius*2).toFixed(3);
    }
}
