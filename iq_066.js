...
captureModelImage(captureWidth = 800, captureHeight = 800) {
    return new Promise((resolve) => {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                }, 10); // Longer delay for CSS2D positioning
            }, 10);
        }, 10);
    });
}
...
<div class="title-block"><div style="display:flex;"><p class="delete">x</p><p class="line-title" profileId="1">Line `+ lineItem +` (`+ unit +`) Circular Lumen Profile</p><p class="edit" id="`+ lineItem +`">Edit</p></div>${thumbnailHtml}</div>
