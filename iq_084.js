...
const material = new THREE.MeshStandardMaterial({ 
    ...
    <div class="input-group">
        ...
        <input class="range-slider ${hole.color}" type="range" min="0.015" max="${maxHoleDiameter.toFixed(3)}" value="${(hole.radius * 2).toFixed(4)}" step="0.001" id="hole-${index}-diameter-range" >
    ...
    `;
        ...
        <div class="input-group">
            <label>Distance:</label>
            <input type="range" class="range-slider ${hole.color}" min="0" max="${(this.cylinderRadius * 0.8).toFixed(3)}" value="${hole.distance.toFixed(4)}" step="0.001" id="hole-${index}-distance-range">
        ...
        <div class="input-group">
            <label>Angle:</label>
            <input type="range" class="range-slider ${hole.color}" min="0" max="360" value="${Math.round(hole.angle)}" step="1" id="hole-${index}-angle-range">
