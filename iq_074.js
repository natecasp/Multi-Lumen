...
CircularHolesSystem.prototype.captureModelImage = async function(width = 400, height = 400) {
...
clearCircularPrintElements() {
    ...
    this.setupInteraction();
          ...
          PieSliceSystem.prototype.captureModelImage = async function(width = 400, height = 400) {
    return await captureCurrentSystemThumbnail();
};
          updateToHighQuality() {
...
class CrescentSystem {
  ...
  CrescentSystem.prototype.captureModelImage = async function(width = 400, height = 400) {
    return await captureCurrentSystemThumbnail();
};
    updateToHighQuality() {
...
class SmileSystem {
  ...
  SmileSystem.prototype.captureModelImage = async function(width = 400, height = 400) {
    return await captureCurrentSystemThumbnail();
};
  updateToHighQuality() {
