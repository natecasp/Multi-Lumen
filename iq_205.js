...
createHoleCenterCircle() {
    ...
    this.createCircleOutline(0, 0, holeDistance, z);
}
createInterHoleSpacingDimensions() {
    ...
    for (let i = 0; i < peripheralHoles.length; i++) {
        ...
        // End points of perpendicular lines
        ...
        // Connect the END points instead of start points
        ...
        const labelX = (end1X + end2X) / 2 + perpX * 0.02; // Small offset from connecting line
        const labelY = (end1Y + end2Y) / 2 + perpY * 0.02;
