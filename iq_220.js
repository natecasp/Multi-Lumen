...
function calculate() {
  if (checkMaterial() && checkOD() && checkLength() && checkQuantity() && checkSurfaceArea() && debouncedCheckCentralHoleCompliance() && checkHoleDistribution()) {
