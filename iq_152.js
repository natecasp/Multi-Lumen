...
function applyHoleChanges() {
    ...
    if (system instanceof CircularHolesSystem) {
        ...
        system.includeCentralLumen = includeCentralLumen;
        system.regenerateHoles(holeCount);
        ...
        const wasCentralHole = system.hasCentralHole;
        system.hasCentralHole = hasCentralHole;
        
        if (system.hasCentralHole) {
            const innerDiameterSlider = document.getElementById('inner-diameter');
            system.innerDiameter = parseFloat(innerDiameterSlider.value);
            system.updateInnerDiameterLimits();
        }
        
        const success = system.regenerateSlices(adjustedHoleCount);
        
        if (!success) {
            system.hasCentralHole = wasCentralHole;
        ...
        system.regenerateHoles(adjustedHoleCount);
    }
    
    // Update journey tracking
    const step = 'Hole configuration changed';
    updateJourney(step);
}
