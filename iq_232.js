...
function calculate() {
  var checkMaterial = checkMaterial();
  var checkOD = checkOD();
  var checkLength = checkLength();
  var checkQuantity = checkQuantity();
  var checkSurfaceArea = checkSurfaceArea();
  var checkCentralHoleCompliance = checkCentralHoleCompliance();
  var checkHoleDistribution = checkHoleDistribution();
