...
setupCamera() {
    ...
    this.perspectiveCamera = new THREE.PerspectiveCamera(50, window.innerWidth / window.innerHeight, 0.001, 2);
    ...
    this.holes.forEach((hole, index) => {
        ...
        let controlsHTML = `
          <div class="input-box">
            ...
            <input class="text-field-3 slider" type="number" id="h${index}-diameter" value="${(hole.radius * 2).toFixed(4)}" min="0.015" max="0.06" step="0.001">
        ...
        if (!isCentralLumen) {
            ...
            <input class="text-field-3 slider" type="number" id="h${index}-distance" min="0" max="${maxPosition.toFixed(3)}" value="${hole.distance.toFixed(4)}" step="0.001">
          ...
          <div class="input-box">
            ...
            <input class="text-field-3 slider" type="number" id="h${index}-angle" min="0" max="360" value="${hole.angle}" step="1">
        ...
        titleContainer.appendChild(controlsTitleHTML);
