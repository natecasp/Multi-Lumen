...
updateCircularDiameterLimits() {
    ...
    if (circularRadiusSlider && circularRadiusInput) {
        ...
        let minCircularDiameter = getBaseValues(unit).defaultWallThickness; // Basic minimum
...
// Fallback functions for systems without print mode
    ...
    if (innerDiameterSlider && innerDiameterInput) {
        ...
        innerDiameterSlider.max = getBaseValues(unit).maxInnerDiameter; // Allow up to 50cm diameter
