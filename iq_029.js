...
function checkMaterial() {
  if (['Pebax 72D','Pebax 63D', 'Pebax 55D','Pebax 45D','Pebax 40D','Pebax 35D','Vestamid ML21', 'Pellethane 55D', 'Pellethane 65D'].includes(this.value)) {
    return true;
  }
  else {
    return false;
...
function checkOD() {
  if(Number($("#cylinder-diameter-input").val()) >= 0.100 && Number($("#cylinder-diameter-input").val()) <= 0.300 ) {
    return true;
  } else {
    return false;
  }
