...
class GlobalErrorSystem {
    ...
    createErrorContainer() {
        ...
        const targetParent = getElementById('error-parent'); // or wherever you want to place it
        targetParent.appendChild(errorContainer);
        
        this.container = errorContainer;
    }
// Add a new error
    addError(id, title, description) {
...
function addError(id, title, description) {
    return globalErrorSystem.addError(id, title, description);
}
  ...
  if(window.profileManager.currentSystem instanceof CircularHolesSystem) {
    ...
    if (needsCentralHole) {
      ...
      addError(
            ...
            'The current design has excessive material in the center. Adding a central lumen will optimize material usage and reduce manufacturing costs.'
        );
