   ...
   autoExitPrintMode();
    ...
    if (isAltPressed) {
        ...
        if (this.isValidPosition(x, y, hole.radius, this.activeHoleIndex)) {
            ...
            // IMPORTANT: Don't update hole coordinates if position is invalid
            // The visual elements will stay at their last valid position
            console.log('Distance movement blocked - would exceed valid bounds');
        }
    }
    } else {
