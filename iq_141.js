...
function checkCrescentCornersAboveCircularMidline(crescentSystem) {
    ...
    // Get the crescent geometry to find corner positions
    ...
    // The corner Y positions are at the intersection points
    const cornerY = crescentGeometry.intersectionY;
    ...
    console.log(`   Crescent corner Y: ${cornerY.toFixed(4)}${unit}`);
