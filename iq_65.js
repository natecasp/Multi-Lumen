...
<div class="title-block"><div style="display:flex;"><p class="delete">x</p><p class="line-title">Line `+ lineItem +` (`+ unit +`)</p><p class="edit" id="`+ lineItem +`">Edit</p></div>${thumbnailHtml}</div>
