...
createHoleCenterCircle() {
    ...
    for (let i = 0; i < peripheralHoles.length; i++) {
        ...
        // Calculate perpendicular direction (for extending outward)
        const perpX = -dirY;
        const perpY = dirX;
        ...
        // Connect the two start points with a dimension line
        ...
        // Place label at midpoint of the connecting line
        const labelX = (start1X + start2X) / 2 + perpX * (extensionLength * 0.7);
        const labelY = (start1Y + start2Y) / 2 + perpY * (extensionLength * 0.7);
